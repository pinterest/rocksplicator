...
public class Participant {
  ...
  private static final String
      ...
      "handoffClientEventHistoryJsonShardMapPath";
  private static final String upstreamClusterConnectStringFlagName = "upstreamClusterConnectString";
  private static final String upstreamClusterNameFlagName = "upstreamClusterName";
  ...
  private static Options constructCommandLineOptions() {
    ...
    Option upstreamClusterConnectStringOption =
        OptionBuilder.withLongOpt(upstreamClusterConnectStringFlagName)
            .withDescription(
                "zk Connect String for upstream cluster to follow for rocksobserver").create();
    upstreamClusterConnectStringOption.setArgs(1);
    upstreamClusterConnectStringOption.setRequired(false);
    upstreamClusterConnectStringOption.setArgName(
        "Zk connect string for upstream cluster to follow for rocksobserver (Optional)");

    Option upstreamClusterNameOption =
        OptionBuilder.withLongOpt(upstreamClusterNameFlagName)
            .withDescription(
                "cluster name for upstream cluster to follow for rocksobserver").create();
    upstreamClusterNameOption.setArgs(1);
    upstreamClusterNameOption.setRequired(false);
    upstreamClusterNameOption.setArgName(
        "cluster name string for upstream cluster to follow for rocksobserver (Optional)");
    ...
    options.addOption(zkServerOption)
        ...
        .addOption(upstreamClusterConnectStringOption)
        .addOption(upstreamClusterNameOption);
    return options;
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    final String upstreamClusterConnectString = cmd.getOptionValue(upstreamClusterConnectStringFlagName, "");
    final String upstreamClusterName = cmd.getOptionValue(upstreamClusterNameFlagName, "");
    ...
    Participant participant = new Participant(zkConnectString, clusterName, instanceName,
        stateModelType, Integer.parseInt(port), postUrl, useS3Backup, s3BucketName, runSpectator, upstreamClusterConnectString, upstreamClusterName);
  ...
  private Participant(String zkConnectString, String clusterName, String instanceName,
                      ...
                      String s3BucketName, boolean runSpectator, String upstreamClusterConnectString, String upstreamClusterName)
      throws Exception {
    ...
    if (stateModelType.equals("OnlineOffline")) {
      ...
      stateModelFactory = new CdcLeaderStandbyStateModelFactory(
          zkConnectString, port, upstreamClusterConnectString, upstreamClusterName);
    } else {
