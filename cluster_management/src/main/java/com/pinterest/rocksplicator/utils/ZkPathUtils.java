...
public class ZkPathUtils {
  ...
  private static final String BASE_PATH_ROCKSOBSERVER_METADATA
      = "/rocksobserver-dataset-metadata";
  ...
  public static String getRocksObserverMetadataPath(String resourceName) {
    return String.format("%s/%s", BASE_PATH_ROCKSOBSERVER_METADATA, resourceName);
  }
}
